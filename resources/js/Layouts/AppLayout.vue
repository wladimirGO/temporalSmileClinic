                ...
                <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('tratamientos.index')" :active="route().current('tratamientos.*')">
                                    Tratamientos
                                </jet-nav-link>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('pacientes.index')" :active="route().current('pacientes.*')">
                         ...
                         <jet-responsive-nav-link :href="route('tratamientos.index')" :active="route().current('tratamientos.*')">
                            Tratamientos
                        </jet-responsive-nav-link>
